...
| [JsonFusion](https://github.com/tucher/JsonFusion) | [![GitHub stars](https://img.shields.io/github/stars/tucher/JsonFusion?style=social)](https://github.com/tucher/JsonFusion/stargazers/) | JSON/CBOR <-> C++, with validation and no glue code. | [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) |
